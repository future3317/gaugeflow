...
ACTIVE_ENTRYPOINTS = (
    ...
    ROOT / "scripts" / "build_h0_e_parent_decomposition_pilot.py",
    ROOT / "scripts" / "diagnose_h0_e_parent_decomposition.py",
    ROOT / "scripts" / "audit_h0_e_parent_decomposition_pilot.py",
)
