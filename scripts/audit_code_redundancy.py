...
ACTIVE_ENTRYPOINTS = (
    ...
    ROOT / "scripts" / "qualify_h1a_factorized_cartesian_angular_moments.py",
    ROOT / "scripts" / "audit_h1a_local_geometry_errors.py",
    ROOT / "scripts" / "audit_h1a_tangent_score_index_correction.py",
    ...
    ROOT / "scripts" / "audit_h1a_self_conditioned_topology.py",
    ROOT / "scripts" / "audit_h1a_self_conditioned_carrier_localization.py",
    ROOT / "scripts" / "qualify_h1a_nonlinear_pair_conversion.py",
    ROOT / "scripts" / "evaluate_h1a_coordinate_clean_side_information.py",
    ...
    ROOT / "scripts" / "train_h1a_assignment_iid.py",
)
