...
- MatPES-PBE H0-C is qualified with frozen TensorNet and QET checkpoints: 512 held-out structures and 32 transformation-audit structures passed the versioned metric, covariance, identity and runtime checks. These teachers are restricted to offline supervision and uncertainty fields.
...
3. Preserve the qualified MatPES teacher manifest and offline-only policy.
