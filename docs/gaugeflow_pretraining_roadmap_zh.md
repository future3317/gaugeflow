...
- learned orderless assignment、\(p(B,N)\)、lattice L1、near-prior 完整坐标反向轨迹、
  generated-side-state coordinates 与 joint M1。
...
数据以 Alex-MP-20 的 540,164 条 train 为结构主池，validation/test 固定不动。训练
