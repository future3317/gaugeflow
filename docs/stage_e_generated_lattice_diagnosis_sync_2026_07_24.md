...
The official artifact exactly matches the temporary combo evaluation.  The
checkpoint SHA-256 differs because the official checkpoint was regenerated by
the committed projection tool, but the measured metrics are identical:

| metric | official value |
| --- | ---: |
| all replay role total losses lower | yes |
| clean_clean replay loss delta | -0.00017905235290527344 |
| generated_assignment replay loss delta | -0.001874685287475586 |
| generated_lattice replay loss delta | -0.0013530254364013672 |
| generated_joint replay loss delta | -0.0034461021423339844 |
| free NN-W1 delta | +0.0024332300859237765 |
| free volume-W1 delta | -0.000040659420989408446 |
| free distance-valid delta | 0.0 |
| exact composition delta | 0.0 |
| finite-positive lattice delta | 0.0 |
| sampling failures delta | 0.0 |
| volume bootstrap 95% CI | [-0.0007411272712751895, +0.00030002156927976496] |
| P(volume delta <= 0) | 0.6155 |

Current boundary:

1. The official projection may be recorded as a diagnostic trust-projection
   candidate.
2. It is not a production checkpoint and not a Stage-E pass.
3. Do not continue E-v1 scalar adapter tuning.
4. Require at least one independent support/window check before any capacity
